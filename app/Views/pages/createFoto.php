...
<div class="container">
    <div class="row">
        <div class="row-8">
            ...
            <form action="/Profile/saveFoto" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="id_fotografer" class="form-control d-none  " id="id_fotografer" value="<?= $fotoGallery[0]['id_fotografer']; ?>">
                </div>
                <div class="mb-3">
